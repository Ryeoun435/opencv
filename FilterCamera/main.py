...
from loadImages import cat_ears_image, bear_ears_image, see_overlay, work_out_overlay
...
class VideoWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        filters = [
            ...
            ("fish eye", 4, None, False),
            ("handsome", 8, see_overlay, False),
            ("work out", 8, work_out_overlay, False)
    ...
    def update_frame(self):
        ...
        for face in faces:
            ...
            frame = apply_filter_mode(frame, self.filter_mode, self.current_overlay, face, landmarks, face_width)
    ...
    def capture_image(self):
        ...
        for face in faces:
            landmarks = predictor(gray, face)
            face_width = face.right() - face.left()
            frame = apply_filter_mode(frame, self.filter_mode, self.current_overlay, face,
